        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{ $post->title }}" class="form-control" placeholder="{{ __('index.title') }}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control height-area" name="description" placeholder="{{ __('index.description') }}">{{ $post->description }}</textarea>
                </div>
            </div>
